...
setInterval(() => {
    http.get(`http://spam-a-1-v3.glitch.me/`);
}, 280000);
...
client.on('message', message => {
    ...
    if(message.content === prefix +'work'){
		setTimeout(async function (){
        message.channel.send(' الحساب رقم 1 يعمل <:701181142421995571:711738090921918525>')
}, 1000
)
  }});
client2.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 2 يعمل <:701181142421995571:711738090921918525>')
}, 2000
)
  }});
client3.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 3 يعمل <:701181142421995571:711738090921918525>')
}, 3000
)
  }});
client4.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 4 يعمل <:701181142421995571:711738090921918525>')
}, 4000
)
  }});
client5.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 5 يعمل <:701181142421995571:711738090921918525>')
}, 5000
)
  }});
client6.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 6 يعمل <:701181142421995571:711738090921918525>')
}, 6000
)
  }});
client7.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 7 يعمل <:701181142421995571:711738090921918525>')
}, 7000
)
  }});
client8.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 8 يعمل <:701181142421995571:711738090921918525>')
}, 8000
)
  }});
client9.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 9 يعمل <:701181142421995571:711738090921918525>')
}, 9000
)
  }});
client10.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 10 يعمل <:701181142421995571:711738090921918525>')
}, 10000
)
  }});
client11.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 11 يعمل <:701181142421995571:711738090921918525>')
}, 11000
)
  }});
client12.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 12 يعمل <:701181142421995571:711738090921918525>')
}, 12000
)
  }});
client13.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 13 يعمل <:701181142421995571:711738090921918525>')
}, 13000
)
  }});
client14.on('message', message => {
    ...
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 14 يعمل <:701181142421995571:711738090921918525>')
}, 14000
)
  }});client15.on('message', message => {
	  if (!config.kahrbaaid.includes(message.author.id)) return;
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 15 يعمل <:701181142421995571:711738090921918525>')
}, 15000
)
  }});client16.on('message', message => {
	  if (!config.kahrbaaid.includes(message.author.id)) return;
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 16 يعمل <:701181142421995571:711738090921918525>')
}, 16000
)
  }});client17.on('message', message => {
	  if (!config.kahrbaaid.includes(message.author.id)) return;
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 17 يعمل <:701181142421995571:711738090921918525>')
}, 17000
)
  }});client18.on('message', message => {
	  if (!config.kahrbaaid.includes(message.author.id)) return;
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send('<:701181142421995571:711738090921918525> الحساب رقم 18 يعمل')
}, 18000
)
  }});client19.on('message', message => {
	  if (!config.kahrbaaid.includes(message.author.id)) return;
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 19 يعمل <:701181142421995571:711738090921918525>')
}, 19000
)
  }});client20.on('message', message => {
	  if (!config.kahrbaaid.includes(message.author.id)) return;
    if(message.content === prefix +'work'){
setTimeout(async function (){
        message.channel.send(' الحساب رقم 20 يعمل <:701181142421995571:711738090921918525>')
}, 20000
)
  }});
// ======= [ test work - INFO end ] ======== //
